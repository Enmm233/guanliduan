...
<article class="main">
  ...
  <article class="adminisus_list">
    <section class="adminissu_cp">
      <section class="adminissu_cpw">{{ mine.mobile }}</section>
    </section>
    <section class="clear"></section>
    <ol>
      <li><router-link to="/shiji_change"><img src="../../../../static/img/adminis_pic.png" alt=""/><cite>修改密码</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
      <li><router-link to="/shiji_problem"><img src="../../../../static/img/adminis_pic1.png" alt=""/><cite>常见问题</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
      <li><router-link to="/shiji_vehicle"><img src="../../../../static/img/adminis_pic5.png" alt=""/><cite>车辆位置</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
