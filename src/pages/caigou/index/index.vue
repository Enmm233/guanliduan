  ...
  <article class="main">
    <article class="adminisin_bj">
      ...
      <section class="adminisin_bjw">
        <cite>{{ buyerIndex.buyerNum }}</cite>
        <section class="adminisin_bjw_l">
          <address>
            <aside>未采数量</aside><dfn>{{ buyerIndex.unBuyerNum }}</dfn>
          </address>
          <address>
            <aside>应采数量</aside><dfn>{{ buyerIndex.total }}</dfn>
          </address>
        </section>
      </section>
    </article>
    ...
    <article class="adminisin_list">
      <ol>
        ...
        <li>
          ...
          <aside>{{ buyerIndex.unfinsh }}</aside>
        </li>
        <section class="adminis_gd"></section>
        <li>
          <i class="fa fa-ellipsis-v"></i>
          ...
          <aside>{{ buyerIndex.cateCount }}</aside>
        </li>
        <section class="adminis_gd"></section>
        <!--<li>
        <i class="fa fa-ellipsis-v"></i>
        ...
        <aside>{{ buyerIndex.beforeFinsh }}</aside>
      </li>
      <section class="adminis_gd"></section>
      <li>
        <i class="fa fa-ellipsis-v"></i>
        ...
        <aside>{{ buyerIndex.beforeUnfinsh }}</aside>
      </li>-->
        <!--<section class="adminis_gd"></section>-->
      </ol>
    </article>
