  ...
  methods: {
    ...
    submit: function() { 
      if(this.inputtext.old_pwd==''){
        ...
        this.$post(APIUrl.buyerModifyPassword,{appid:APIUrl.appid,old_pwd:old_pwd,password:password,password_confirmation:password_confirmation,timeStamp:APIUrl.timeStamp,sign:sign1})
        .then((response) => {
