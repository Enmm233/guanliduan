...
<article class="main">
  ...
  <article class="adminisus_list">
    ...
    <ol>
      <li><router-link to="/gongying_change"><img src="../../../../static/img/adminis_pic.png" alt=""/><cite>修改密码</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
      <li><router-link to="/gongying_problem"><img src="../../../../static/img/adminis_pic1.png" alt=""/><cite>常见问题</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
      <li><router-link to="/gongying_monthly"><img src="../../../../static/img/adminis_pic2.png" alt=""/><cite>各月账单</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
...
export default {
  ...
  methods: {
        ...
        // 绑定微信
        adminisus_list_p(){
            let url="http://"+window.location.host+'/Mobile#/gongying_user';
      ...
      this.$get(APIUrl.mine,{appid:APIUrl.appid,timeStamp:APIUrl.timeStamp,sign:sign})
        ...
        if(code!='')
        {
            let sign1=this.$md5('appid='+APIUrl.appid+'&timeStamp='+APIUrl.timeStamp+APIUrl.appsecret);
                this.$get(APIUrl.supplierBind,{appid:APIUrl.appid,code:code,timeStamp:APIUrl.timeStamp,sign:sign1})
                .then((response) => {
                    this.$Indicator.close();
                    if(response.code==401)
                    {
