			...
			<ol>
				...
				<li>
					...
					<section class="adminisad_list_z">
							...
							<input type="text" name="code_h" placeholder="输入用户编码" v-model="inputtext.code_h" autocomplete="off" class="acc_inp adminisad_list_in">
						</div>
					</section>
				</li>
				<li>
...
//					console.log(this.inputtext);
					this.$post(APIUrl.salesmanMemberCreate, {
						appid: APIUrl.appid,
						nickname: nickname,
						mobile: mobile,
						password: password,
