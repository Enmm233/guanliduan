...
<article class="main">
  ...
  <article class="adminisus_list">
    ...
    <ol>
      <li><router-link to="/yewu_change"><img src="../../../../static/img/adminis_pic.png" alt=""/><cite>修改密码</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
      <li><router-link to="/yewu_problem"><img src="../../../../static/img/adminis_pic1.png" alt=""/><cite>常见问题</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
      <li><router-link to="/yewu_monthly"><img src="../../../../static/img/adminis_pic2.png" alt=""/><cite>各月业绩</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
      <li><router-link to="/yewu_money"><img src="../../../../static/img/adminis_pic8.png" alt=""/><cite>我要收款</cite><i class="fa fa-angle-right"></i></router-link></li>
	  <section class="adminis_gd1"></section>
      <li><router-link :to="'/yewu_code?uid='+mine.uid"><img src="../../../../static/img/adminis_pic11.png" alt=""/><cite>二维码名片</cite><i class="fa fa-angle-right"></i></router-link></li>
      <section class="adminis_gd1"></section>
